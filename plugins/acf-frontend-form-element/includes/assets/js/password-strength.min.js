...
jQuery(document).ready(function(a){a("body").on("keyup",".password_main input",function(b){checkPasswordStrength(a(this),a(this).parents(".acf-input-wrap").siblings(".pass-strength-result"),[])});a("body").on("keyup",".password_confirm input",function(b){b=a(this).parents(".password_confirm").siblings(".password_main").find("input[type=password]");checkPasswordsMatch(a(this),b,a(this).parents(".acf-input-wrap").siblings(".pass-strength-result"))})});//c=c.concat(wp.passwordStrength.userInputDisallowedList());